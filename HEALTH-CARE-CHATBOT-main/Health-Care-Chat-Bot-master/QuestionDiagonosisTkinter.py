...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health-Care Chatbot", bg="#8A307F", width="300", height="2", font=("fira code", 13))
        self.lblMsg.pack()
        ...
        self.lblTeam=Label(self, text="Made by:", bg="#79A7D3", width = "250", height = "1", font=("fira code", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Abdul Raheem", bg="#6883BC", width = "250", height = "1", font=("fira code", 13))
        self.lblTeam1.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="#8A307F")
        self.lblMsg.pack()
